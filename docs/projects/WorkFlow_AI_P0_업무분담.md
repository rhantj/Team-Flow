...
| FR-04 | 회의록 업로드 (문서 업로드·텍스트 추출·AI 분석) | **박지수 (FS-2)** | 유소은 (FS-6) | LLM, File Parser |
| FR-05 | To-Do 자동 생성 (업무 추출·담당자 후보·미배정 처리) | **박지수 (FS-2)** | 허영주 (FS-3) | LLM, Function Calling |
